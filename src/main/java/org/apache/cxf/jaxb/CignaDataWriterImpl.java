...
public class CignaDataWriterImpl<T> extends JAXBDataBase implements DataWriter<T> {
    ...
    boolean noEscape;
    private CignaJaxBDataBinding databinding;
    private Bus bus;

    public CignaDataWriterImpl(Bus bus, CignaJaxBDataBinding binding) {
        this(bus, binding, false);
    }
    public CignaDataWriterImpl(Bus bus, CignaJaxBDataBinding binding, boolean noEsc) {
